                ...
                createActionsColumn<Floor>({
                    ...
                    renderActions: (floor) => (
                        <>
                            ...
                            {auth.permissions.floors.delete && (
                                <DeleteDialog
                                    id={floor.id}
                                    onDelete={handleDeleteFloor}
                                    title={t('ui.floors.delete.title') || 'Delete floor'}
                                    description={
                                        t('ui.floors.delete.description') ||
            ...
            <div className="p-6">
                <div className="space-y-6">
                    <div className="flex items-center justify-between">
                        ...
                        {auth.permissions.floors.create && (
                    ...
                    <div className="w-full rounded-2xl border p-4 shadow-md">
                        ...
                        <div className="mt-2 text-right">
                            ...
                            <span className="ml-1 font-bold text-blue-600">{floors?.meta.total}</span>
                        </div>
                    </div>
