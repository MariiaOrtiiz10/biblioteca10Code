...
return [
    'appearance' => [
        'created' => 'appearance created successfully',
        'updated' => 'appearance updated successfully',
        'deleted' => 'appearance deleted successfully',
        'error' => [
            'create' => 'Error creating appearance',
            'update' => 'Error updating appearance',
            'delete' => 'Error deleting appearance',
        ],
    ],
    'users' => [
    ...
    'books' => [
        ...
        'noDeleted' => 'You cannot delete this book because it is currently borrowed',
        'error' => [
