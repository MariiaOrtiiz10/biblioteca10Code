...
return [
    'appearance' => [
        'created' => 'Apariencia creada correctamente',
        'updated' => 'Apariencia actualizada correctamente',
        'deleted' => 'Apariencia eliminada correctamente',
        'error' => [
            'create' => 'Error al crear la apariencia',
            'update' => 'Error al actualizar la apariencia',
            'delete' => 'Error al eliminar la apariencia',
        ],
    ],
    'users' => [
    ...
    'books' => [
        ...
        'noDeleted' => 'No puedes eliminar este libro porque está actualmente prestado',
        'error' => [
    ...
    'loans' => [
        ...
        'returned' => 'Préstamo devuelto correctamente',
        'error' => [
